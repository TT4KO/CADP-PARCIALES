...
LA PANADERIA AGRUPA A SUS PRODUCTOS EN 26 CATEGORIAS[POR EJ..1. PAN; 2.MEDIALUNAS;
PARA CADA CATEGORIA SE CONOCE SU NOMBRE Y EL PRECIO POR KILO DEL PRODUCTO].
LA PANADERIA "DISPONE" DE INFORMACION DE TODAS LAS COMPRAS REALIZADA EN EL ULTIMO AÑO. 
DE CADA COMPRA SE CONOCE EL DNI DEL CLIENTE, 
LA CATEGORIA DEL PRODUCTO(ENTRE 1 Y EL 26) Y LA CANTIDAD DE KILOS COMPRADOS. 
LA INFORMACION -SE ENCUENTRE ORDENADA POR DNI DEL CLIENTE-.

A)REALIZAR UN MODULO QUE RETORNE LA INFORMACION DE LAS CATEGORIAS EN UNA ESTRUCUTA DE DATOS ADECUADAS.
LA INFORMACION SE LEE POR TELCADO SIN NINGUN ORDEN.
